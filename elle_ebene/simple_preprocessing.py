...
from elle_ebene.params import RESIZING_DIM, COLOR_BACKGROUND, VALID_IMAGES
import os
...
def get_images(folder_name, resizing_dim = RESIZING_DIM, valid_images = VALID_IMAGES, path = "/home/aymeric/code/Aymeric-B/elle_ebene/raw_data"):
    """
